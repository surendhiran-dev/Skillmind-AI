...
from backend.app.models.models import User, Score, Resume, Skill
...
def seed_data():
    ...
    with app.app_context():
        ...
        resume = Resume(
            user_id=user.id,
            filename='resume.pdf',
            raw_text='Python Backend Developer with 5 years experience in Flask and SQL.',
            processed_text='Python Backend Developer',
